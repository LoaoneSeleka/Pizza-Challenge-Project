...
-- Create the pizza type table with relevant attributes
CREATE TABLE pizza_type(
pizza_type_id VARCHAR(250) PRIMARY KEY,
pizza_name text NOT NULL,
pizza_category VARCHAR(200),
pizza_ingredients text
);

--Insert data into the pizza type table
INSERT INTO 
	pizza_type(pizza_type_id,pizza_name,pizza_category,pizza_ingredients)
VALUES
...
--View if data has been inserted into the pizza type table
SELECT * 
	FROM pizza_type;